...
[ID, INCOME_1993, INTERVIEW_MONTH_1993, WKS_WORKED_SPS_1993, WKS_WORKED_1993, ...
    EAST_1993, NORTH_1993, SOUTH_1993, WEST_1993, NEVERMARRIED_1993, MARRIED_1993, OTHER_1993, ...
    DROPOUT_1993, HS_1993, COLLEGE_1993, RISK_1993, AGE_1993, MISSING_INCOME_1993, MISSING_WKS_1993, MISSING_WKS_SPS_1993, ...
    INCOME_2002, INTERVIEW_MONTH_2002, WKS_WORKED_SPS_2002, WKS_WORKED_2002, ...
    EAST_2002, NORTH_2002, SOUTH_2002, WEST_2002, NEVERMARRIED_2002, MARRIED_2002, OTHER_2002, ...
    DROPOUT_2002, HS_2002, COLLEGE_2002, RISK_2002, AGE_2002, MISSING_INCOME_2002, MISSING_WKS_2002, MISSING_WKS_SPS_2002, ...
    INCOME_2004, INTERVIEW_MONTH_2004, WKS_WORKED_SPS_2004, WKS_WORKED_2004, ...
    EAST_2004, NORTH_2004, SOUTH_2004, WEST_2004, NEVERMARRIED_2004, MARRIED_2004, OTHER_2004, ...
    DROPOUT_2004, HS_2004, COLLEGE_2004, RISK_2004, AGE_2004, MISSING_INCOME_2004, MISSING_WKS_2004, MISSING_WKS_SPS_2004,...
    INCOME_2006, INTERVIEW_MONTH_2006, WKS_WORKED_SPS_2006, WKS_WORKED_2006, ...
    EAST_2006, NORTH_2006, SOUTH_2006, WEST_2006, NEVERMARRIED_2006, MARRIED_2006, OTHER_2006, ...
    DROPOUT_2006, HS_2006, COLLEGE_2006, RISK_2006, AGE_2006, MISSING_INCOME_2006, MISSING_WKS_2006, MISSING_WKS_SPS_2006,...
    INCOME_2010, INTERVIEW_MONTH_2010, WKS_WORKED_SPS_2010, WKS_WORKED_2010, ...
    EAST_2010, NORTH_2010, SOUTH_2010, WEST_2010, NEVERMARRIED_2010, MARRIED_2010, OTHER_2010, ...
    DROPOUT_2010, HS_2010, COLLEGE_2010, RISK_2010, AGE_2010, MISSING_INCOME_2010, MISSING_WKS_2010, MISSING_WKS_SPS_2010,...
    INCOME_2012, INTERVIEW_MONTH_2012, WKS_WORKED_SPS_2012, WKS_WORKED_2012, ...
    EAST_2012, NORTH_2012, SOUTH_2012, WEST_2012, NEVERMARRIED_2012, MARRIED_2012, OTHER_2012, ...
    DROPOUT_2012, HS_2012, COLLEGE_2012, RISK_2012, AGE_2012, MISSING_INCOME_2012, MISSING_WKS_2012, MISSING_WKS_SPS_2012,...
...
lINCOME_1993(INCOME_1993 == 0) = 0; lINCOME_2002(INCOME_2002 == 0) = 0; lINCOME_2004(INCOME_2004 == 0) = 0; lINCOME_2006(INCOME_2006 == 0) = 0; lINCOME_2010(INCOME_2010 == 0) = 0; lINCOME_2012(INCOME_2012 == 0) = 0; lINCOME_2014(INCOME_2014 == 0) = 0;
...
W93 = zeros(N,20); W02 = zeros(N,20); W04 = zeros(N,20); W06 = zeros(N,20); W10 = zeros(N,20); W12 = zeros(N,20); W14 = zeros(N,20);

ii = find(INTERVIEW_1993 > 0);
    W93(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_1993(ii), NORTH_1993(ii), SOUTH_1993(ii), WEST_1993(ii), ...
        NEVERMARRIED_1993(ii), MARRIED_1993(ii), OTHER_1993(ii), AGE_1993(ii), URATE_1993(ii), ICS_1993(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];  

ii = find(INTERVIEW_2002 > 0);
    W02(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_2002(ii), NORTH_2002(ii), SOUTH_2002(ii), WEST_2002(ii), ...
        NEVERMARRIED_2002(ii), MARRIED_2002(ii), OTHER_2002(ii), AGE_2002(ii), URATE_2002(ii), ICS_2002(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];     

ii = find(INTERVIEW_2004 > 0);
    W04(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_2004(ii), NORTH_2004(ii), SOUTH_2004(ii), WEST_2004(ii), ...
        NEVERMARRIED_2004(ii), MARRIED_2004(ii), OTHER_2004(ii), AGE_2004(ii), URATE_2004(ii), ICS_2004(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];      

ii = find(INTERVIEW_2006 > 0);
    W06(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_2006(ii), NORTH_2006(ii), SOUTH_2006(ii), WEST_2006(ii), ...
        NEVERMARRIED_2006(ii), MARRIED_2006(ii), OTHER_2006(ii), AGE_2006(ii), URATE_2006(ii), ICS_2006(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];   

ii = find(INTERVIEW_2010 > 0);
    W10(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_2010(ii), NORTH_2010(ii), SOUTH_2010(ii), WEST_2010(ii), ...
        NEVERMARRIED_2010(ii), MARRIED_2010(ii), OTHER_2010(ii), AGE_2010(ii), URATE_2010(ii), ICS_2010(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];     

ii = find(INTERVIEW_2012 > 0);
    W10(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_2012(ii), NORTH_2012(ii), SOUTH_2012(ii), WEST_2012(ii), ...
        NEVERMARRIED_2012(ii), MARRIED_2012(ii), OTHER_2012(ii), AGE_2012(ii), URATE_2012(ii), ICS_2012(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];  

ii = find(INTERVIEW_2014 > 0);
    W10(ii,:) = [ones(size(ii)), BLACK(ii), HISPANIC(ii), EAST_2014(ii), NORTH_2004(ii), SOUTH_2014(ii), WEST_2014(ii), ...
        NEVERMARRIED_2014(ii), MARRIED_2014(ii), OTHER_2014(ii), AGE_2014(ii), URATE_2014(ii), ICS_2014(ii), ...
        MOM_HGC(ii), DAD_HGC(ii), AGE_14(ii), AFQT_2006(ii)/10000, MISSING_MOM_HGC(ii), MISSING_DAD_HGC(ii), MISSING_AFQT(ii)];  
...
save ../Output/MATLAB_sample ID X* W* N DROPOUT* HS* COLLEGE* FEMALE* RISK* lINCOME* zINCOME* BLACK HISPANIC WKS* MARRIED* OTHER* AGE* MISSING*
diary off;
...
[Egamma4_93,Egamma4_02,Egamma4_04,Egamma4_06,Egamma4_10,Egamma4_12,Egamma4_14] = Egamma(b,RISK_1993,RISK_2002,RISK_2004,RISK_2006,RISK_2010,RISK_2012,RISK_2014,[XW93,ones(N,1)],[XW02 ,ones(N,1)],...
    ...
    X = XW93 - repmat(mean(XW93),N,1);
    g = zeros(B,1);
    g(1:K,1) = va_14^-.5*(X'*X)*b(1:K)/N;
    g(K+2) = va_14^-.5*sigmau;
    se_va14 = (g'*V*g)^0.5;    
...
fprintf('Model 14: Log Risk Tolerance Mean = %1.3f (%1.3f) Std Dev = %1.3f (%1.3f)\n', mu_14, se_mu14, va_14^.5, se_va14);
