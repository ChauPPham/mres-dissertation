...
\usepackage{caption}
\usepackage{threeparttable, makecell, cellspace, multirow, booktabs, diagbox, tabularx, longtable, threeparttablex, siunitx}
%\usepackage{verbatim}
\usepackage{natbib}
...
The approach to estimate the effect of risk preference on parental inputs naturally differ under the two assumptions of risk preference as discussed previously. 
