...
\begin{titlingpage}
	\begin{center}
		...
		\begin{minipage}[!h]{.89\linewidth}
			...
			\begin{itemize}
				\itembox an empirical/econometric study
...
\begin{table}[!htbp]
	...
	\begin{threeparttable}
		...
		\begin{tablenotes}[flushleft]\footnotesize
			\item The table reports MLE estimation of parameters of log risk tolerance and response error under the assumption of time-invariant risk preference following \eqref{eq:A-likelihood-constant-univariate} and \eqref{eq:A-likelihood-constant-bivariate}, and time-invariant risk preference following \eqref{eq:A-likelihood-floating-univariate}. Standard error enclosed in parentheses.
		\end{tablenotes}
	\end{threeparttable}
