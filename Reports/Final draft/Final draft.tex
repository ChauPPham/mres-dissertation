...
\begin{abstract}
\noindent 
This article studies the effect of maternal risk preference on investment in children. 
\end{abstract}
...
\end{equation}
where $X_{it}$ denotes the set of characteristics of the respondents at the time of the survey, $t$.
