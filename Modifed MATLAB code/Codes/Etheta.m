function [Etheta92] = Etheta(b,c93,c02,c04,c06,c10,c12,c14,X93,X02,X04,X06,X10,X12,X14)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Etheta.m
...
if model < 10 
    Etheta92 = exp(muX93+sigmau^2/2).*(num./den);
elseif model >= 10    
    Etheta92 = exp(X93(:,1:end-1)*b(1:K-1)+sigmau^2/2).*(num./den);
end
